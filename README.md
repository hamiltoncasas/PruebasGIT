...
> **Nota:** los campos de fecha son de texto con formato `AAAA-MM-DD` porque GitHub Issue Forms **no soporta** `type: date` (usarlo hace que el formulario deje de aparecer).
